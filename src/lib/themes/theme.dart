...
// Icons
const addIcon = Icons.add_circle_outline;
const menuIcon = Icons.menu;
const openInIcon = Icons.open_in_new;
const downloadIcon = Icons.download;
const settingsIcon = Icons.tune;
const folderOpenIcon = Icons.folder_open;
const saveIcon = Icons.save;
const trashIcon = Icons.delete;
